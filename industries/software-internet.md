...
研发、测试、DevOps、AI 应用工程、平台工程最先落地的一组场景。

## 先看哪些岗位

- [AI 平台工程师](../roles/ai-platform.md)：4 个 Skill
- [开发工程师](../roles/engineering.md)：4 个 Skill
- [技术负责人/研发效能负责人](../roles/engineering-management.md)：4 个 Skill
- [基础设施/运维负责人](../roles/infra-ops.md)：3 个 Skill
- [QA/测试负责人](../roles/qa-testing.md)：2 个 Skill
- [工作流架构师](../roles/workflow-architecture.md)：2 个 Skill
- [成本治理负责人](../roles/cost-governance.md)：2 个 Skill
- [数字员工架构师](../roles/digital-employee-architect.md)：2 个 Skill
- [研发平台/GitHub 管理员](../roles/engineering-platform.md)：2 个 Skill
...
|---|---|---|---|---|
|[openai/codex](https://github.com/openai/codex)|开发工程师<br>技术负责人/研发效能负责人<br>QA/测试负责人|r-and-d|medium|适合给会看代码的人提速：读仓库、修小 bug、跑命令都顺手，但前提是有人审、有人测。|
...
|[github/github-mcp-server](https://github.com/github/github-mcp-server)|研发平台/GitHub 管理员<br>运营/行政/流程管理员<br>技术负责人/研发效能负责人|r-and-d<br>operations-admin|medium|如果团队已经把 issue、PR、review 都放在 GitHub，这个 server 很适合接给开发型数字员工。先管好 token，再谈自动化。|
...
|[obra/superpowers](https://github.com/obra/superpowers)|技术负责人/研发效能负责人<br>开发工程师<br>工作流架构师|r-and-d<br>operations-admin|low|如果团队已经在用 AI 写码，但总要靠人最后收烂摊子，可以先看它怎么把 spec、测试、验收往前放。它更像流程样本，不是万能外挂。|

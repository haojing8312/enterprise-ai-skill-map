...
整理文档、沉淀经验、维护可检索的知识资产。

## 适用行业

- [通用企业/内部运营](../industries/general-enterprise.md)：3 个 Skill
...
|---|---|---|---|---|
|[microsoft/markitdown](https://github.com/microsoft/markitdown)|通用企业/内部运营<br>专业服务：法律/咨询/研究<br>内容/媒体/营销服务|office<br>marketing-content<br>legal-compliance|low|企业里一堆 PDF、PPT、Word 进不了 AI 流程时，它能先把格式摊平。别把转换后的 Markdown 当原件。|
|[mem0ai/mem0](https://github.com/mem0ai/mem0)|通用企业/内部运营<br>零售/电商/客服密集型|office<br>customer-service<br>operations-admin|medium|如果你的助手老是前后失忆，或者客服每轮都像第一次接触用户，可以研究它。但记得先把保留期、删除和纠错机制想清楚。|
